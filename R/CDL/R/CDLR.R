...
PMV  = c(20, 0.3, 0.2, 0.4, 2, 0)
PHW  = c(0, 0.3, 0.2, 0, 2, 0)
PMAR = c(0.92, 3, 20, 400, 0) 
PKER = c(250,250,1,0)
PKS = c(200,200,1,10)
...
# visualize(ind7,scalarFR(ind7,PNON,methodCode("Non-Parametric"),state),PNON)
...
gplot3 <- function(d,m,labels,title,f=c( "blue", "red", "green", "orange", "violet", "cyan","darkblue", "darkred", "darkgreen", "darkorange", "darkviolet", "darkcyan" )) {
 ...
 w1 <- c("/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/astar/cpistalls-t_48.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/libquantum/cpistalls-t_24.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/bzip2/cpistalls-t_49.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/mcf/cpistalls-t_25.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/gcc/cpistalls-t_35.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/omnetpp/cpistalls-t_37.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/gobmk/cpistalls-t_45.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/perlbench/cpistalls-t_39.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/h264ref/cpistalls-t_58.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/sjeng/cpistalls-t_54.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/hmmer/cpistalls-t_42.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/5_10_SPECCPU2006INT/xalancbmk/cpistalls-t_43.csv")

  w2 <- c("/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/astar/cpistalls-t_70.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/libquantum/cpistalls-t_36.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/bzip2/cpistalls-t_76.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/mcf/cpistalls-t_39.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/gcc/cpistalls-t_51.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/omnetpp/cpistalls-t_55.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/gobmk/cpistalls-t_68.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/perlbench/cpistalls-t_81.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/h264ref/cpistalls-t_88.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/sjeng/cpistalls-t_82.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/hmmer/cpistalls-t_60.csv",
          "/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_SPECCPU2006INT/xalancbmk/cpistalls-t_66.csv")

 w1name <- c("astar-cpistalls-t_48.pdf",
          "libquantum-cpistalls-t_24.pdf",
          "bzip2-cpistalls-t_49.pdf",
          "mcf-cpistalls-t_25.pdf",
          "gcc-cpistalls-t_35.pdf",
          "omnetpp-cpistalls-t_37.pdf",
          "gobmk-cpistalls-t_45.pdf",
          "perlbench-cpistalls-t_39.pdf",
          "h264ref-cpistalls-t_58.pdf",
          "sjeng-cpistalls-t_54.pdf",
          "hmmer-cpistalls-t_42.pdf",
          "xalancbmk-cpistalls-t_43.pdf")
 w2name <- c("astar-cpistalls-t_70.pdf",
          "libquantum-cpistalls-t_36.pdf",
          "bzip2-cpistalls-t_76.pdf",
          "mcf-cpistalls-t_39.pdf",
          "gcc-cpistalls-t_51.pdf",
          "omnetpp-cpistalls-t_55.pdf",
          "gobmk-cpistalls-t_68.pdf",
          "perlbench-cpistalls-t_81.pdf",
          "h264ref-cpistalls-t_88.pdf",
          "sjeng-cpistalls-t_82.pdf",
          "hmmer-cpistalls-t_60.pdf",
          "xalancbmk-cpistalls-t_66.pdf")


rosario <- function(search,w){


  W = vector("list",length(w))
  T = vector("list",length(w))
  ref = read.csv(search,header=FALSE)
  for (j in 1:length(w)) {
    print(w[j])
    W[[j]] = read.csv(w[j],header=FALSE)
  }
  for (j in 1:length(w)) {
    dr = dim(ref)
    dw = dim( W[[j]])
    print (c(dr,dw))
    r = array(0,dim = c(dr[1], dr[2]+dw[2]))
...
rosarioWarmup <- function(search,w){
  ...
  for (j in 1:length(w)) {
    ...
    dw = dim( W[[j]])
    print (c(dr,dw))
    r = array(0,dim = c(dr[1], dr[2]+2*dw[2]))
...
rosarioScan <- function(search,w, t=TRUE, rank=FALSE){
  ...
  if (t == FALSE)  {
    ref = t( ref)
    L = ref[2:length(ref[,1]),1]
    ref = ref[,2:length(ref[1,])]

    if (rank == TRUE) {
      d = dim(ref)
      for (k in 1:d[2]) {
        ref[2:d[1],k] = order( ref[2:d[1],k])
      }
  ...
  for (j in 1:length(w)) {
    ...
    if (dr[2]>dw[2]) { 
      ...
      r = array(0,dim = c(dr[1], dw[2]+2*dr[2]))
      for (i in 1:dr[1]) {
...
compareRosarioScan <- function(S,i,tit) {
  res = list()
  labels = list()
  summary = list()
  j = 1
  ...
  y <- rmar[[YVAL]]> 0 & rmar[[XVAL]]> 2*N 
  if (sum(y)>0) {
    print(c(M,tit,"different"))
    summary[[j]] =  c(M,tit,"different")
  }  
  else { 
    print (c(M,tit,"indistinguishable"))
    summary[[j]] =  c(M,tit,"indistinguishable")
  }
  ...
  visualize4(t,int,res,labels,tit,S[[i]][[4]])
...
compareRosario <- function(S,i,M,t) {

  if (M=="Kernels")  {
    PKER[1] = S[[i]][[1]]
    PKER[2] = S[[i]][[2]]
    state = ""
    r = scalarFR(S[[i]][[3]],PKER,methodCode(M),state)
    visualize2(S[[i]][[3]],r,PKER,t=t)
    x <- r[[XVAL]]> 0
    if (max(r[[PVAL]][x]) >= 0.95) {
      
      print(c(M,t,"different"))
      c(M,t,"different")
    } 
    else { 
      c(M,t,"indistinguishable")
    }
  } else if (M=="Non-Parametric") {
    PNON[1] = S[[i]][[1]]
    PNON[2] = S[[i]][[2]]
    state = ""
    r = scalarFR(S[[i]][[3]],PNON,methodCode(M),state)
    visualize2(S[[i]][[3]],r,PNON,t=t)
    x <- r[[XVAL]]> 0
    if (max(r[[PVAL]][x]) >= 0.95) {
    ...
    PMAR[5] = S[[i]][[1]]
    state = ""
    r = scalarFR(S[[i]][[3]],PMAR,methodCode(M),state)
    visualize2(S[[i]][[3]],r,PMAR,lg=TRUE,t=t)
    y <- r[[YVAL]]> 0
    print(c("y",y,sum(y)))
    ...
    PKS[2] = S[[i]][[1]]
    state = ""
    r = scalarFR(S[[i]][[3]],PKS,methodCode(M),state)
    visualize2(S[[i]][[3]],r,PKS,t=t)
    x <- r[[XVAL]]> 0
    if (max(r[[PVAL]][x]) >= 0.95) {
...
rosarioPlot <- function(S,w,comp=compareRosario) {
  res = list()
  ...
  for (i in 1:length(S)) {
    ...
    N = w[i]
    name = paste(i,N,sep="-")
    png(file=name, width=14, height=10,units="in",bg="transparent",res=120)
...
onesearch <- function(M,w,wn) {

  if (M=="Compression" || M=="Martingale") {
    S = rosarioWarmup("/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_fsearch/cpistalls-t_53.csv",w)
  }
  else { 
    S = rosario("/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_fsearch/cpistalls-t_53.csv",w)
  }
  res = rosarioPlot(S[[1]],M,wn)
  print(res)
  
  res
}

oneidpd <- function(M,w,wn) {

  S = rosarioScan("/export/crawlspace/Paolo/FastLibrary_Multidimensional/DATA/Paolo/3_5_IDPD/idpd_cpistalls-t_225.csv",w)
  res = rosarioPlot(S[[1]],M,wn,comp=compareRosarioScan)
  print(res)
  
  res
}

idpdname <- "idpd_cpistalls"
...
oneidpdMachine <- function(Machine,wn,r=FALSE) {
  ...
  S = rosarioScan(idpdlocation,tempwm,t=FALSE, rank=r)
  res = rosarioPlot(S[[1]],names,comp=compareRosarioScan)
  print(res)

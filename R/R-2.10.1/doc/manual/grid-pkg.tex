...
font & Font face (alias for fontface;  for
...
\code{\LinkA{panel.identify}{panel.identify}} in package \pkg{lattice}.
\end{SeeAlso}
%
\begin{Examples}
\begin{ExampleCode}
...
There is a hook called \code{"grid.newpage"} (see \code{\LinkA{setHook}{setHook}})
...
\end{Examples}
\inputencoding{latin1}
\HeaderA{stringWidth}{Create a Unit Describing the Width of a String}{stringWidth}
